 ...
 *
 * @author pgier
 * @version $Id: SourceJarNoForkMojo.java 1355857 2012-07-01 08:03:27Z olamy $
 * @since 2.1
 */
    ...
    extends AbstractSourceJarMojo
{
    ...
    protected List<String> getSources( MavenProject p )
    {
    	...
    	paths.addAll(p.getCompileSourceRoots());
    	paths.add(p.getBasedir().getAbsolutePath() + "/target/generated-sources/apt/");
